...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="2.0" xmlns:c="https://schemas.dataspecer.com/xsd/core/" xmlns:ns0="https://slovník.gov.cz/legislativní/sbírka/111/2009/pojem/">
  ...
  <xsl:template match="/adresní_místo">
    <rdf:RDF>
  ...
  <xsl:template name="_https_003a_002f_002fofn.gov.cz_002fclass_002f1657559334424-059d-9a4b-9c94">
    ...
    <rdf:Description>
      ...
      <xsl:for-each select="kód">
        <ns0:má-kód-adresního-místa rdf:datatype="http://www.w3.org/2001/XMLSchema#string">
          <xsl:apply-templates select="@*"/>
          <xsl:value-of select="."/>
        </ns0:má-kód-adresního-místa>
      </xsl:for-each>
    </rdf:Description>
  </xsl:template>
  <xsl:template match="@*|*"/>
